...
class DynamicController extends BbsController
{
    ...
    public function push(DynamicRequest $request): JsonResponse
    {
        ...
        $dynamic_id = $this->service->push($this->getLoginUserId(), $request->all());

        return $this->successJson(compact('dynamic_id'), $this->service->getError());
    }
    ...
    public function update(DynamicRequest $request, $dynamic_id): JsonResponse
    {
        ...
        $dynamic_id = $this->service->update($this->getLoginUserId(), $dynamic_id, $request->all());

        return $this->successJson(['dynamic_id' => $dynamic_id], $this->service->getError());
    }
