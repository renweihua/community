 ...
 * @property-read \App\Models\Article\ArticleContent|null $content
 * @property-read string $article_cover
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Article\ArticleLabel[] $labels
