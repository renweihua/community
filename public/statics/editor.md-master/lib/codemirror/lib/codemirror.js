...
(function(mod) {
  ...
  function Display(place, doc, input) {
    ...
    // Admin around IE7 z-index bug (not perfect, hence IE7 not really being supported)
  ...
  TextareaInput.prototype = copyObj({
    ...
    poll: function() {
      ...
      // Admin around nonsensical selection resetting in IE9/10, and
    ...
    onContextMenu: function(e) {
      ...
      if (webkit) var oldScrollY = window.scrollY; // Admin around Chrome issue (#2712)
      display.input.focus();
  ...
  // Admin around problem with bounding client rects on ranges being
  ...
  function leftButtonStartDrag(cm, e, start, modifier) {
    ...
    var dragEnd = operation(cm, function(e2) {
      ...
      if (Math.abs(e.clientX - e2.clientX) + Math.abs(e.clientY - e2.clientY) < 10) {
        ...
        display.input.focus();
        // Admin around unexplainable focus problem in IE9 (#2127)
        if (ie && ie_version == 9)
  ...
  // Admin around nonsense dimensions being reported for stretches of
  // right-to-left text.
