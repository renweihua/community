  ...
  <view class="br8r mtb18r mlr18r bgwhite" style="overflow: hidden;">
    ...
    <view class="ptb18r plr18r">
      ...
      <view class="flex flex-aic">
        <user-avatar @click="$emit('user',infoData.User)" :src="infoData.User.HeadUrl ? infoData.User.user_head : '/static/default_avatar.png'"
          :tag="infoData.user_info.uuid" size="sm"></user-avatar>
