<template>
	<view class="br8r mtb18r mlr18r bgwhite" style="overflow: hidden;">
		<image
			...
			:src="infoData.FaceSrc ? infoData.FaceSrc + '_850x300.jpg/format/webp' : '/static/default_image.png'"
			mode="scaleToFill"
			:lazy-load="true"
		></image>
		<view class="ptb18r plr18r">
			...
			<view class="flex flex-aic">
				<user-avatar
					@click="$emit('user', infoData.User)"
					:src="infoData.User.HeadUrl ? infoData.User.HeadUrl + '_100x100.jpg' : '/static/default_avatar.png'"
					:tag="infoData.User.AuthenticateCode"
					size="sm"
				></user-avatar>
...
<script>
import { fnCutString, fnFormatLocalDate } from '@/utils/CommonUtil.js';
