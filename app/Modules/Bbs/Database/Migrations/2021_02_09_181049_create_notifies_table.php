...
class CreateNotifiesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('notifies', function (Blueprint $table) {
            ...
            $table->bigInteger('notify_type')->unsigned()->default(0)->comment('消息类型：0.系统消息；1.互动消息；');
            ...
            $table->bigInteger('target_type')->unsigned()->default(0)->comment('目标类型：1.动态；2.关注');
            $table->bigInteger('sender_id')->unsigned()->default(0)->comment('发送者Id');
            $table->bigInteger('sender_type')->unsigned()->default(0)->comment('发送者类型：0.系统通知');
