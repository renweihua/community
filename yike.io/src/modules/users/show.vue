<template>
    <div class="page-user-show" v-if="user.user_id > 0">
        ...
        >
            ...
            >
                <img :src="user.user_info ? user.user_info.user_avatar : ''" alt="User avatar"
                     class="avatar avatar-120">
                <div class="ml-md-3">
                    <h1 class="mt-2 mb-0">
                    ...
                    <div class="extends text-white d-none d-md-block d-lg-flex" v-if="!user.banned_at">
                        ...
                        <div class="mr-1" v-if="user.user_info && user.user_info.other_extends.home_url">
                            ...
                            <a class="text-white" target="_blank" :href="user.user_info.other_extends.home_url">{{
                                user.user_info.other_extends.home_url }}</a>
                        </div>
                        <div class="mr-1">
